...
export default function SideNav({ onLinkClick }) {
  ...
  return (
    <div className="bg-[#FFFFFF] flex flex-col lg:w-[320px] w-screen space-y-4">
      <div className="px-4 hidden md:block">
        <img src="/adminlogo.png" alt="Bayasel Logo"/>
      </div>
      
      <nav className='pb-12 pl-3 lg:pl-0 space-y-4 lg:space-y-0'>
        <Link 
          to='overview' 
          onClick={() => handleLinkClick('overview')} 
          className={`flex gap-2.5 py-3 px-3 rounded-lg font-semibold text-xl lg:mx-2 transition duration-300 ease-in-out transform hover:scale-105 w-fit ${
